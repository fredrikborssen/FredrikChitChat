...
namespace ChittyChatty.Data.Migrations
{
    ...
    [Migration("20230726092612_TryToMakeFkOptioal")]
    partial class TryToMakeFkOptioal
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChittyChatty.Domain.Entites.BrokerListing", b =>
                {
                    ...
                    b.ToTable("BrokerListings", t =>
                        {
                            t.HasCheckConstraint("CK_BuildId_Houses_Apartments", "[BuildingId] IS NOT NULL OR [BuildingId] IS NOT NULL");
                        });
                });
